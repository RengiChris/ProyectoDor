...
<template>
  <!-- <div class="post card flex-md-column mb-4 box-shadow h-md-250" v-bind:data-category="props.event.tag">
    ...
    <div class="card-body d-flex flex-column align-items-start">
      ...
      <div class="mb-1 text-muted">{{getDiff(props.event.date)}}</div>
      ...
      <div id="comentarios">
        <Comentario v-for="comentario in props.event.comments" :comment="comentario" />
      </div>
       <textarea name="" id="" cols="30" rows="10"></textarea> 
      
      <div class="avatar card mt-2 flex-row p-2 w-100" >
        <img class="rounded-circle" :src="comentario.thumb" alt="">
        <div class="card-body p-1 px-3">
          <h6 class="card-subtitle mb-2  text-muted">{{ comentario.usuario.toLowerCase() }} </h6>
